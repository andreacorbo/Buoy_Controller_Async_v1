...
CRON = (
    ...
    ['gps', ['last_fix'], 'f_lock', None, None, None, None, range(5, 60, 10), 0, None],             # every 10' start @ 5' 25''
    ['gps', ['log','last_fix'], 'f_lock', None, None, None, None, range(10, 60, 10), 0, None],      # every 10' start @ 10' 25''
    ['gps', ['log','last_fix','sync_rtc'], 'f_lock', None, None, None, None, 0, 0, None],           # every 1h  start @ 0' 25''
    ['meteo', ['log'], 'f_lock', None, None, None, None, range(0, 60, 10), 1, None],                 # every 10' start @ 0' 0''
